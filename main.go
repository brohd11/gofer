...
// launch it, and $GOFER_CD_FILE hands the directory you quit in back to a shell wrapper so
// the explorer can move your shell with you. It is the thinnest possible consumer of
